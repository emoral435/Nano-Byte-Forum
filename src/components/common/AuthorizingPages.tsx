...
const AuthorizingPages = ({bg, msg, setEmail, setPassword, handleFormSubmit, handleSide, user} :Props) => {
  return (
    <div className='flex md:flex-row flex-col-reverse items-center'>
        ...
        <div className='w-full h-[100vh] bg-[#ebf3f9] flex flex-col justify-center items-center lg:items-start'>
            ...
            <div className='flex md:flex-row flex-col-reverse gap-8'>
                ...
                <Form title='Login' sideTitle='Sign Up' setEmail={setEmail} setPassword={setPassword} handleForm={handleFormSubmit} handleSide={handleSide}/>
                </div>
