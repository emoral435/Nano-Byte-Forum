        ...
        <>
            <h1 className='text-7xl font-["Georgia"] flex flex-col-reverse items-center justify-center md:flex-row md:justify-around md:items-center select-none text-[#333333] h-[40vh] w-full bg-stone-300'>
                ...
                <div className='flex justify-center overflow-hidden'>
                    <img src={OTP} alt="Woman On Phone" className='hidden md:block object-cover md:h-[50rem] md:mt-64 hover:scale-100 scale-[120%] transition ease-in-out duration-200'/>
                </div>
            </h1>
...
const LayerTwo = () => {
    return (
        <>
            <h2 className='w-full flex flex-col justify-start items-start'>
                <Statistics />
            </h2>
        </>
    )
